...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2020 at 11:35 PM
...
INSERT INTO `bidang` (`id`, `nama_bidang`, `fungsi_id`, `urusan_id`) VALUES
(101, 'Pendidikan', 10, 1),
(102, 'Kesehatan', 7, 1),
(103, 'Pekerjaan Umum dan Penataan Ruang', 6, 1),
(104, 'Perumahan Rakyat dan Kawasan Pemukiman', 6, 1),
(105, 'Ketentraman dan Ketertiban Umum serta Perlindungan Masyarakat', 3, 1),
(106, 'Sosial', 11, 1),
(201, 'Tenaga Kerja', 4, 2),
(202, 'Pemberdayaan Perempuan dan Perlindungan Anak', 11, 2),
(203, 'Pangan', 1, 2),
(204, 'Pertanahan', 5, 2),
(205, 'Lingkungan Hidup', 5, 2),
(206, 'Administrasi Kependudukan dan Capil', 11, 2),
(207, 'Pemberdayaan Masyarakat Desa', 4, 2),
(208, 'Pengendalian Penduduk dan Keluarga Berencana', 7, 2),
(209, 'Perhubungan', 4, 2),
(210, 'Komunikasi dan Informatika', 1, 2),
(211, 'Koperasi, Usaha Kecil dan Menengah', 4, 2),
(212, 'Penanaman Modal', 4, 2),
(213, 'Kepemudaan dan Olah Raga', 10, 2),
(214, 'Statistik', 1, 2),
(215, 'Persandian', 1, 2),
(216, 'Kebudayaan', 8, 2),
(217, 'Perpustakaan', 10, 2),
(218, 'Kearsipan', 1, 2),
(301, 'Kelautan dan Perikanan', 4, 3),
(302, 'Pariwisata', 8, 3),
(303, 'Pertanian', 4, 3),
(304, 'Kehutanan', 4, 3),
(305, 'Energi dan Sumberdaya Mineral', 4, 3),
(306, 'Perdagangan', 4, 3),
(307, 'Perindustrian', 4, 3),
(308, 'Transmigrasi', 4, 3),
(401, 'Administrasi Pemerintahan', 1, 4),
(402, 'Pengawasan', 1, 4),
(403, 'Perencanaan', 1, 4),
(404, 'Keuangan', 1, 4),
(405, 'Kepegawaian', 1, 4),
(406, 'Pendidikan dan Pelatihan', 1, 4),
(407, 'Penelitian dan Pengembangan', 1, 4);

-- --------------------------------------------------------

--
-- Table structure for table `bpkp`
--

CREATE TABLE `bpkp` (
  `id` int(2) NOT NULL,
  `kd_prov` int(2) DEFAULT NULL,
  `kd_kl` int(3) DEFAULT NULL,
...
--
-- Dumping data for table `bpkp`
--

INSERT INTO `bpkp` (`id`, `kd_prov`, `kd_kl`, `nama_unit`, `alamat`, `email`, `telepon`, `website`, `updated_at`) VALUES
(11, NULL, NULL, 'BPKP Aceh', 'Jl. Teuku Iskandar Jl. Panglima Nyak Makam, Lambhuk, Kec. Ulee Kareng, Kota Banda Aceh, Aceh 23127', 'aceh@bpkp.go.id', '(0651) 28183', 'sumut@bpkp.go.id', '2020-04-23 18:20:38'),
(12, NULL, NULL, 'BPKP Sumatera Utara', 'Jl. Gatot Subroto No.KM. 5.5, Simpang Tj., Kec. Medan Sunggal, Kota Medan, Sumatera Utara 20123', NULL, '(061) 8474847', 'bpkp.go.id', '0000-00-00 00:00:00'),
(13, NULL, NULL, 'BPKP Sumatra Barat', NULL, NULL, NULL, NULL, NULL),
(14, NULL, NULL, 'BPKP Riau', NULL, NULL, NULL, NULL, NULL),
(15, NULL, NULL, 'BPKP Jambi', NULL, NULL, NULL, NULL, NULL),
(16, NULL, NULL, 'BPKP Sumatra Selatan', NULL, NULL, NULL, NULL, NULL),
(17, NULL, NULL, 'BPKP Bengkulu', NULL, NULL, NULL, NULL, NULL),
(18, NULL, NULL, 'BPKP Lampung', NULL, NULL, NULL, NULL, NULL),
(19, NULL, NULL, 'BPKP Bangka Belitung', NULL, NULL, NULL, NULL, NULL),
(21, NULL, NULL, 'BPKP Kepulauan Riau', NULL, NULL, NULL, NULL, NULL),
(31, NULL, NULL, 'BPKP DKI Jakarta', NULL, NULL, NULL, NULL, NULL),
(32, NULL, NULL, 'BPKP Jawa Barat', NULL, NULL, NULL, NULL, NULL),
(33, NULL, NULL, 'BPKP Jawa Tengah', NULL, NULL, NULL, NULL, NULL),
(34, NULL, NULL, 'BPKP Yogyakarta', NULL, NULL, NULL, NULL, NULL),
(35, NULL, NULL, 'BPKP Jawa Timur', NULL, NULL, NULL, NULL, NULL),
(36, NULL, NULL, 'BPKP Banten', NULL, NULL, NULL, NULL, NULL),
(51, NULL, NULL, 'BPKP Bali', NULL, NULL, NULL, NULL, NULL),
(52, NULL, NULL, 'BPKP Nusa Tenggara Barat', NULL, NULL, NULL, NULL, NULL),
(53, NULL, NULL, 'BPKP Nusa Tenggara Timur', NULL, NULL, NULL, NULL, NULL),
(61, NULL, NULL, 'BPKP Kalimantan Barat', NULL, NULL, NULL, NULL, NULL),
(62, NULL, NULL, 'BPKP Kalimantan Tengah', NULL, NULL, NULL, NULL, NULL),
(63, NULL, NULL, 'BPKP Kalimantan Selatan', NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `check_pemda`
--

CREATE TABLE `check_pemda` (
  `id` int(11) NOT NULL,
  `kriteria` varchar(100) DEFAULT NULL,
  `pertimbangan` text DEFAULT NULL,
  `kesimpulan` varchar(100) DEFAULT NULL,
  `pemda_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `check_pemda`
--

INSERT INTO `check_pemda` (`id`, `kriteria`, `pertimbangan`, `kesimpulan`, `pemda_id`, `created_at`, `updated_at`) VALUES
(0, NULL, NULL, NULL, NULL, '2020-05-18 23:11:25', '2020-05-18 23:11:25'),
(2, 'Kesehatan', 'Banyak Pelayanan Kesehatan Yang berlum Terpenuhi', 'Terpenuhi', 1, '2020-05-18 16:14:46', '2020-05-18 16:14:46'),
(3, 'Lainnya', 'Bukan Termasuk bagian dari pelayanan kesehatan', 'Tidak Terpenuhi', 2, '2020-05-18 16:15:57', '2020-05-18 16:15:57');
...
CREATE TABLE `fungsi` (
  `id` int(11) NOT NULL,
  `nama_fungsi` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `fungsi` (`id`, `nama_fungsi`) VALUES
(1, 'Pelayanan Umum'),
(2, 'Pertahanan'),
...
--
-- Table structure for table `idk_sasaran_kp`
--

CREATE TABLE `idk_sasaran_kp` (
  `id` int(11) NOT NULL,
  `nama_idk_kp` text DEFAULT NULL,
  `stn_idk_kp` varchar(100) DEFAULT NULL,
  `tgt_idk_kp` varchar(200) DEFAULT NULL,
  `ktr_idk_kp` varchar(200) DEFAULT NULL,
  `sasaran_pp_id` int(11) DEFAULT NULL,
  `sasaran_kp_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `idk_sasaran_kp`
--

INSERT INTO `idk_sasaran_kp` (`id`, `nama_idk_kp`, `stn_idk_kp`, `tgt_idk_kp`, `ktr_idk_kp`, `sasaran_pp_id`, `sasaran_kp_id`, `created_at`, `updated_at`) VALUES
(1, 'Tidak ada anak yang putus sekolah', 'persen(%)', '100', NULL, 1, 1, '2020-05-18 15:52:07', '2020-05-18 15:52:07'),
(2, 'Keluarga dapat berobat tanpa harus dipungut biaya', 'persen(%)', '100', NULL, 3, 2, '2020-05-18 16:00:32', '2020-05-18 16:00:32'),
(3, 'Anak - anak bisa sekolah kembali', 'persen(%)', '100', NULL, NULL, 1, '2020-06-07 18:56:48', '2020-06-07 18:56:48'),
(4, 'Masyarakat mendapatkan pendidikannya kembali', 'persen(%)', '90', NULL, NULL, 1, '2020-06-09 12:03:08', '2020-06-09 12:03:08'),
(5, 'Masyarakat mendapatkan pendidikannya kembali', 'persen(%)', '90', NULL, NULL, 7, '2020-06-09 12:46:02', '2020-06-09 12:46:02');

-- --------------------------------------------------------

--
-- Table structure for table `idk_sasaran_pp`
--

CREATE TABLE `idk_sasaran_pp` (
  `id` int(11) NOT NULL,
  `nama_idk_pp` text DEFAULT NULL,
  `stn_idk_pp` varchar(100) DEFAULT NULL,
  `tgt_idk_pp` varchar(255) DEFAULT NULL,
  `ktr_idk_pp` varchar(200) DEFAULT NULL,
  `sasaran_pp_id` int(11) DEFAULT NULL,
  `sasaran_kp_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp()
...
--
-- Dumping data for table `idk_sasaran_pp`
--

INSERT INTO `idk_sasaran_pp` (`id`, `nama_idk_pp`, `stn_idk_pp`, `tgt_idk_pp`, `ktr_idk_pp`, `sasaran_pp_id`, `sasaran_kp_id`, `created_at`, `updated_at`) VALUES
(7, 'Persentase Penerima Pelayanan Dasar SPM Pendidikan Anak Usia Dini (PAUD)', 'persen(%)', '44,84', 'Usia 5 - 6 Tahun', 9, NULL, '2020-06-11 11:44:36', '2020-06-11 11:44:36'),
(8, 'Persentase Penerima Pelayanan Dasar SPM Sekolah Dasar', 'persen(%)', '107,12', 'Usia 7 - 12 Tahun', 9, NULL, '2020-06-11 11:48:32', '2020-06-11 11:48:32'),
(9, 'Persentase Penerima Pelayanan Dasar SPM Sekolah Menengah Pertama', 'persen(%)', '92,73', 'Usia 13 - 15 Tahun', 9, NULL, '2020-06-11 11:50:22', '2020-06-11 11:50:22'),
(11, 'Persentase TK/RA/BA yang berakreditasi minimal B', 'persen(%)', '21,6', NULL, 10, NULL, '2020-06-11 11:56:36', '2020-06-11 11:56:36'),
(12, 'Persentase SD/MI/Sederajat yang berakreditasi minimal B', 'persen(%)', '84,4', NULL, 10, NULL, '2020-06-11 11:59:24', '2020-06-11 11:59:24'),
(13, 'Persentase imunisasi dasar lengkap pada anak usia 12 - 23 bulan', 'persen(%)', '64', 'Usia 12 - 23 Bulan', 5, NULL, '2020-06-11 12:19:10', '2020-06-11 12:19:10');
...
--
-- Table structure for table `kegpri`
--

CREATE TABLE `kegpri` (
  `id` int(3) NOT NULL,
  `kd_kegpri` int(2) DEFAULT NULL,
  `nama_kp` varchar(255) DEFAULT NULL,
  `progpri_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `kegpri`
--

INSERT INTO `kegpri` (`id`, `kd_kegpri`, `nama_kp`, `progpri_id`) VALUES
(1, 1, 'Sistem Jaminan Sosial Nasional', 1),
(2, 2, 'Bantuan Sosial dan Subsidi Tepat Sasaran', 1),
(3, 3, 'Kesejahteraan Sosial', 1),
(4, 4, 'Penguatan Sistem Layanan Terpadu dan Pendampingan', 1),
(5, 5, 'Percepatan Cakupan Administrasi Kependudukan', 1),
(6, 6, 'Integrasi Sistem Administrasi Kependudukan', 1),
(7, 1, 'Peningkatan Kesehatan Ibu, Anak, Keluarga Berencana (KB) dan Kesehatan Reproduksi', 2),
(8, 2, 'Percepatan Perbaikan Gizi dan Masyarakat', 2),
(9, 3, 'Peningkatan Pengendalian Penyakit', 2),
(10, 4, 'Penguatan Germas', 2),
(11, 5, 'Penguatan Pelayanan Kesehatan dan Pengawasan Obat dan Makanan', 2),
(12, 1, 'Peningkatan Kualitas Pengajaran dan Pembelajaran', 3),
(13, 2, 'Afirmasi Akses dan Percepatan Pelaksanaan Wajib Belajar 12 Tahun', 3),
(14, 3, 'Pengelolaan dan Penempatan Pendidik dan Tenaga Kependidikan', 3),
(15, 4, 'Penjaminan Mutu Pendidikan', 3),
(16, 5, 'Penguatan Pendidikan Tinggi Berkualitas', 3),
(17, 6, 'Peningkatan Tata Kelola Pendidikan', 3),
(18, 7, 'Kapabilitas Adopsi Iptek dan Penciptaan Inovasi', 3),
(19, 1, 'Akselerasi Penguatan Ekonomi Keluarga', 4),
(20, 2, 'Keperantaraan Usaha dan Dampak Sosial', 4),
(21, 3, 'Peningkatan Akses Pembiayaan Ultra Mikro', 4),
(22, 4, 'Reforma Agraria dan Perhutanan Sosial', 4),
(23, 1, 'Ketahanan Budaya dan Karakter Bangsa', 5),
(24, 2, 'Pemajuan dan Pelestarian Kebudayaan', 5),
(25, 3, 'Pemahaman dan Pengamalan Nilai-Nilai Agama', 5),
(26, 4, 'Budaya Literasi', 5),
(27, 5, 'Pemenuhan Hak dan Perlindungan Anak, Perempuan, dan Pemuda', 5),
(28, 6, 'Kualitas Keluarga', 5),
(29, 7, 'Prestasi Olahraga', 5),
(30, 1, 'Penyediaan Alkes Perumahan dan Permukiman Layak, Aman, dan Terjangkau', 6),
(31, 2, 'Penyediaan Alkes Air Minum dan Sanitasi yang Layak dan Aman', 6),
(32, 3, 'Keamanan dan Keselamatan Transportasi', 6),
(33, 4, 'Penyediaan dan Pengamanan Air Baku dan Air Tanah', 6),
(34, 1, 'Aksesibilitas Daerah Tertinggal', 7),
(35, 2, 'Ketahanan Kebencanaan Infrastruktur', 7),
(36, 3, 'Pembangunan Terpadu Pesisir Utara Pulau Jawa', 7),
(37, 1, 'Konektivitas Transportasi Jalan', 8),
(38, 2, 'Konektivitas Transportasi Kereta Api', 8),
(39, 3, 'Konektivitas Transportasi Laut', 8),
(40, 4, 'Konektivitas Transportasi Darat', 8),
(41, 1, 'Sistem Angkutan Umum Masal Perkotaan Berbasis Rel', 9),
(42, 2, 'Sistem Angkutan Umum Massal Perkotaan Berbasis Jalan', 9),
(43, 3, 'Infrastuktur Jalan Perkotaan', 9),
(44, 4, 'Penyediaan Akses Air Minum dan Sanitasi Layak dan Aman Perkotaan', 9),
(45, 5, 'Penyediaan Akses Perumahan dan Permukiman Layak, Aman, dan Terjangkau di Perkotaan', 9),
(46, 6, 'Energi Berkelanjutan untuk Perkotaan', 9),
(47, 7, 'Infrastruktur dan Ekosistem TIK Perkotaan', 9),
(48, 1, 'Penuntasan Infrastruktur TIK', 10),
(49, 2, 'Pemanfaatan Infrastruktur TIK', 10),
(50, 3, 'Fasilitas Pendukung Transformasi Digital', 10),
(51, 1, 'Peningkatan Kemitraan Usaha Antara Usaha Mikro Kecil dan usaha Menengah Besar', 11),
(52, 2, 'Peningkatan Akses Pembiayaan Bagi Wirausaha', 11),
(53, 3, 'Peningkatan Kapasitas, Jangkauan, dan Inovasi Koperasi', 11),
(54, 4, 'Peningkatan Penciptaan Peluang Usaha', 11),
(55, 1, 'Peningkatan Industri Berbasis Pertanian yang Terintegrasi Hulu-Hilir', 12),
(56, 2, 'Peningkatan Industri Berbasis Kemaritiman yang Terintegrasi Hulu-Hilir', 12),
(57, 3, 'Peningkatan Produktivitas Dan Nilai Tambah Industri Non-Agro yang Didukung Sistem Bisnis Terintegrasi Hulu-Hilir', 12),
(58, 4, 'Peningkatan Daya Saing Destinasi Dan Industri Pariwisata, Termasuk Wisata Alam, yang Didukung Penguatan Rantai Pasok', 12),
(59, 5, 'Peningkatan Nilai Tambah dan Daya Saing Produk Kreatif Dan Digital', 12),
(60, 6, 'Perbaikan Iklim Usaha dan Peningkatan Investasi', 12),
(61, 7, 'Peningkatan Hilirisasi Sumber Daya Alam, Termasuk Melalui Pengembangan 5melter dan Kawasan Industri Terutama Di Luar Jawa', 12),
(62, 8, 'Pengembangan Industri Halal dan Produk Sehat', 12),
(63, 1, 'Peningkatan Peran dan Kerja Sama Pendidikan dan Pelatihan Vokasi Dunia Usaha', 13),
(64, 2, 'Peningkatan Kualitas Penyelenggaraan Pendidikan dan Pelatihan Vokasi', 13),
(65, 3, 'Peningkatan Sertifikasi Kompetensi', 13),
(66, 4, 'Peningkatan Tata Kelola Pendidikan dan Pelatihan Vokasi', 13),
(67, 1, 'Peningkatan Diversifikasi, Nilai Tambah, dan Daya Saing Produk Ekspor dan Jasa', 14),
(68, 2, 'Peningkatan Akses dan Pendalaman Pasar Ekspor', 14),
(69, 3, 'Peningkatan Efektivitas Free Trade Agreeement (FTA) dan Diplomasi Ekonomi', 14),
(70, 4, 'Peningkatan Partisipasi dalam Global Production Network/GPN (Inbound dan Outbound)', 14),
(71, 5, 'Pengelolaan Impor', 14),
(72, 6, 'Peningkatan Pengadaan Pemerintah yang Menggunakan Produk Dalam Negeri', 14),
(73, 7, 'Peningkatan Citra dan Diversifikasi Pemasaran Pariwisata dan Produk Kreatif', 14),
(74, 1, 'Peningkatan Pendalaman Sektor Keuangan', 15),
(75, 2, 'Optimalisasi Pemantauan Teknologi Digital dan industry 4.0', 15),
(76, 3, 'Penguatan Sistem Logistik dan Stabilitas Harga', 15),
(77, 4, 'Peningkatan Pengembangan Industri dan Pariwisata yang Berkelanjutan', 15),
(78, 5, 'Peningkatan Ketersediaan dan Kualitas Data dan Informasi Perkembangan Ekonomi, Terutama Kemaritiman, Pariwisata, Ekonomi Kreatif, dan Ekonomi Digital', 15),
(79, 6, 'Reformasi Fiskal', 15),
(80, 1, 'Peningkatan Kualitas Konsumsi, Keamanan, Fortifikasi, dan Biofortifikasi Pangan', 16),
(81, 2, 'Peningkatan Ketersediaan Pangan Hasil Pertanian', 16),
(82, 3, 'Peningkatan Produktivitas dan Kesejahteraan SDM Pertanian', 16),
(83, 4, 'Peningkatan Produktivitas dan Keberlanjutan Sumberdaya Pertanian', 16),
(84, 5, 'Tata Kelola Sistem Pangan Nasional', 16),
(85, 6, 'Peningkatan Produksi dan Produktivitas Perikanan dan Produk Laut', 16),
(86, 1, 'Penataan Kawasan Hutan', 17),
(87, 2, 'Pemeliharaan, Pemulihan, dan Konservasi Sumber Daya Air dan Ekosistemnya', 17),
(88, 3, 'Optimasilisasi Pemanfaatan Waduk Multiguna', 17),
(89, 4, 'Pengelolaan Air Terpadu Berbasis Pemanfaatan Teknologi (Smart Water Management)', 17),
(90, 5, 'Modernisasi Pengelolaan Irigasi', 17),
(91, 6, 'Citarum Harum', 17),
(92, 1, 'Akselerasi Pembangunan Energi Terbarukan', 18),
(93, 2, 'Peningkatan Pasokan dan Akses Listrik', 18),
(94, 3, 'Peningkatan Produksi dan Akses Minyak dan Gas', 18),
(95, 4, 'Peningkatan Implementasi Efisiensi Energi', 18),
(96, 5, 'Pengembangan Industri Pendukung EBT', 18),
(97, 1, 'Pencegahan Pencemaran Kerusakan Sumber Daya Alam dan Lingkungan Hidup', 19),
(98, 2, 'Penanggulangan Pencemaran dan Kerusakan Sumber Daya Alam dan Lingkungan Hidup', 19),
(99, 3, 'Pemulihan Pencemaran dan Kerusakan Sumber Daya Alam dan Lingkungan Hidup', 19),
(100, 4, 'Penguatan Kelembagaan dan Penegakan Hukum di Bidang Sumber Daya Alam dan Lingkungan Hidup', 19),
(101, 1, 'Penguatan Kesiapsiagaan Menghadapi Bencana', 20),
(102, 2, 'Penguatan Peringatan Dini Bencana', 20),
(103, 3, 'Penguatan Manajemen Kedaruratan', 20),
(104, 4, 'Percepatan Pemulihan Pascabencana', 20),
(105, 1, 'Peningkatan Kekuatan Pertahanan', 21),
(106, 2, 'Penguatan Kemandirian Pertahanan', 21),
(107, 3, 'Penguatan Kapasitas Kelembagaan Pertahanan dan Keamanan di Wilayah Perbatasan dan Pulau Terluar', 21),
(108, 1, 'Penguatan Diplomasi Politik-Keamanan dan Perbatasan', 22),
(109, 2, 'Penguatan Perlindungan WNI di Luar Negeri', 22),
(110, 3, 'Penguatan Kerjasama Pembanganan Internasional', 22),
(111, 1, 'Penguatan Regulasi', 23),
(112, 2, 'Perbaikan Peradilan Perdata untuk Kemudahan Berusaha', 23),
(113, 3, 'Perbaikan Peradilan Pidana dengan Pendekatan Keadilan Restoratif', 23),
(114, 4, 'Penguatan Upaya Anti Korupsi', 23),
(115, 5, 'Penataan Biaya Politik', 23),
(116, 1, 'Pencegahan dan Pemberantasan Terorisme', 24),
(117, 2, 'Penguatan Ketahanan dan Keamanan Siber', 24),
(118, 3, 'Penguatan Keamanan Laut', 24),
(119, 1, 'Pencegahan, Pemberantasan, dan Rehabilitasi Penyalahgunaan Narkotika', 25),
(120, 2, 'Peningkatan Pemeliharaan Keamanan dan Ketertiban', 25);
...
(3, '2020_04_15_022535_create_pegawai_table', 1);
...
CREATE TABLE `pelaksanaan` (
  ...
  `output_pelaksanaan` text NOT NULL,
  `id_pelaksanaan` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `pemda` (
  ...
  `check_pemda_id` int(11) DEFAULT NULL,
  `anggaran` varchar(100) DEFAULT NULL,
  `realisasi` varchar(100) DEFAULT NULL,
  `program_kegiatan` text DEFAULT NULL,
  `indikator` text DEFAULT NULL,
  `bpkp_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `pemda` (`id`, `provinsi_id`, `kabupaten_id`, `kecamatan_id`, `urusan_id`, `fungsi_id`, `bidang_id`, `unit_id`, `subunit_id`, `check_pemda_id`, `anggaran`, `realisasi`, `program_kegiatan`, `indikator`, `bpkp_id`, `created_at`, `updated_at`) VALUES
(1, 11, 1101, 1101010, 1, 1, 101, 11, 1, 2, NULL, NULL, NULL, NULL, 11, '2020-05-18 16:10:53', '2020-05-18 16:14:46'),
(2, 11, 1101, 1101010, 1, 1, 102, 21, 3, 3, NULL, NULL, NULL, NULL, 11, '2020-05-18 16:15:12', '2020-05-18 16:15:57'),
(3, 11, 1101, NULL, 1, 1, 101, 11, 1, 0, NULL, NULL, NULL, NULL, 11, '2020-05-19 19:28:18', '2020-05-19 19:28:18');
...
CREATE TABLE `perencanaan` (
  `id` int(11) NOT NULL,
  `progres` varchar(100) DEFAULT NULL,
  `bpkp_id` int(11) DEFAULT NULL,
  `obj_pengawasan_id` int(11) DEFAULT NULL,
  `kementerianlembaga_id` int(11) DEFAULT NULL,
  `provinsi_id` int(11) DEFAULT NULL,
  `obj_pelaksanaan` int(11) DEFAULT NULL,
  `obj_tahap` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `perencanaan` (`id`, `progres`, `bpkp_id`, `obj_pengawasan_id`, `kementerianlembaga_id`, `provinsi_id`, `obj_pelaksanaan`, `obj_tahap`, `created_at`, `updated_at`) VALUES
(1, NULL, 11, 1, NULL, NULL, NULL, NULL, '2020-04-24 07:42:29', '2020-04-24 07:42:29');

-- --------------------------------------------------------

--
-- Table structure for table `perenc_objek`
--

CREATE TABLE `perenc_objek` (
  `id` int(11) NOT NULL,
  `obj_pengawasan_1` varchar(255) DEFAULT NULL,
  `obj_pengawasan_2` varchar(200) DEFAULT NULL,
  `obj_pengawasan_3` varchar(200) DEFAULT NULL,
  `obj_pengawasan_4` varchar(200) DEFAULT NULL,
  `obj_pengawasan_5` varchar(200) DEFAULT NULL,
  `bpkp_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
...
--
-- Dumping data for table `perenc_objek`
--

INSERT INTO `perenc_objek` (`id`, `obj_pengawasan_1`, `obj_pengawasan_2`, `obj_pengawasan_3`, `obj_pengawasan_4`, `obj_pengawasan_5`, `bpkp_id`, `created_at`, `updated_at`) VALUES
(11, 'Pengawasan Penyaluran Bantuan Sosial Keluarga Harapan', 'Pengawasan Penyaluran APD Tenaga Medis', 'Pengawasan Bantuan Operasional Sekolah', 'Pengawasan Pelayanan Gizi Masyarakat', 'Pengawasan Distribusi Beras Bulog', 11, '2020-04-21 02:40:35', '2020-04-27 06:44:09'),
(12, 'Pengawasan Pelayanan Kesehatan Ibu Hamil', 'Pengawasan Penyaluran Bantuan Sosial Masyarakat Kurang Mampu', 'Pengawasan Penggunaan Anggaran Belanja Luar Biasa', 'Pengawasan Refocusing Anggaran Belanja', 'Pengawasan Penyaluran Dana Desa', 12, '2020-04-27 04:00:14', '2020-04-27 14:21:43'),
(13, 'Pengawasan Pelayanan Rumah Sakit', 'Pengawasan Penyaluran Bantuan Sosial Masyarakat Kurang Mampu', 'Pengawasan Penggunaan Anggaran ABPD Penanganan Covid', 'Pengawasan Refocusing Anggaran', 'Pengawasan Penyaluran Dana Desa', 13, '2020-04-27 04:00:14', '2020-04-27 11:00:14'),
(20, 'Pengawasan Pelayanan Rumah Sakit', 'Pengawasan Penyaluran Bantuan Sosial Masyarakat Kurang Mampu', 'Pengawasan Penggunaan Anggaran ABPD Penanganan Covid', 'Pengawasan Refocusing Anggaran', 'Pengawasan Penyaluran Dana Desa', 14, '2020-04-27 04:00:14', '2020-04-27 11:00:14');

-- --------------------------------------------------------

--
-- Table structure for table `perenc_pelaksanaan`
--

CREATE TABLE `perenc_pelaksanaan` (
  `id` int(11) NOT NULL,
  `pelaksana_tim` varchar(255) DEFAULT NULL,
  `objek` varchar(255) DEFAULT NULL,
  `tujuan` varchar(255) DEFAULT NULL,
  `progres` varchar(10) DEFAULT NULL,
  `no_st` varchar(100) DEFAULT NULL,
  `bpkp_id` int(11) DEFAULT NULL,
  `pegawai_id` int(11) DEFAULT NULL,
  `perenc_st_id` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `perenc_pelaksanaan`
--

INSERT INTO `perenc_pelaksanaan` (`id`, `pelaksana_tim`, `objek`, `tujuan`, `progres`, `no_st`, `bpkp_id`, `pegawai_id`, `perenc_st_id`, `created_at`, `updated_at`) VALUES
(1, 'Tim 1', 'Pengawasan Penyaluran Bantuan Sosial Keluarga Harapan', 'Untuk Meningkatkan Proses Penyaluran Yang Lebih Efektif', '70%', 'ST/1001/2020', 11, NULL, 1, '2020-04-21 03:12:55', '0000-00-00'),
(11, 'Tim 2', 'Pengawasan Pelayanan Kesehatan Ibu Hamil', 'Untuk Meningkatkan Penyaluran APD Tenaga Medis', '20%', 'ST/1002/2020', 12, NULL, 3, '2020-04-21 00:59:05', '2020-04-27'),
(21, 'Tim 1', 'Pengawasan Pelayanan Kesehatan Ibu Hamil', 'Untuk Meningkatkan Penyaluran APD Tenaga Medis', '20%', 'ST/1002/2020', 13, NULL, 5, '2020-04-21 00:59:05', '2020-04-27'),
(24, 'Tim 1', 'Pengawasan Penggunaan Anggaran Belanja Luar Biasa', 'Untuk Meningkatkan Penyaluran APD Tenaga Medis', '40%', 'ST/1001/2020', 12, NULL, 4, '2020-04-27 07:42:26', '2020-04-27');

-- --------------------------------------------------------

--
-- Table structure for table `perenc_st`
--

CREATE TABLE `perenc_st` (
  `id` int(11) NOT NULL,
  `no_st` varchar(255) DEFAULT NULL,
  `tgl_st` varchar(10) DEFAULT NULL,
  `hari_penugasan` varchar(100) DEFAULT NULL,
  ...
  `bpkp_id` int(11) DEFAULT NULL,
  `objek_pengawasan_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `perenc_st`
--

INSERT INTO `perenc_st` (`id`, `no_st`, `tgl_st`, `hari_penugasan`, `tgl_mulai`, `tgl_selesai`, `tugas`, `unit_pelaksana`, `updated_by`, `file`, `path`, `bpkp_id`, `objek_pengawasan_id`, `created_at`, `updated_at`) VALUES
(3, 'ST/1003/2020', '2020-04-24', 'Senin - Jum\'at', '2020-04-28', '2020-05-01', 'Membuat Aplikasi WasLinSek 2', NULL, NULL, NULL, NULL, 12, 21, '2020-04-23 19:40:44', '2020-04-30 08:28:21'),
(4, 'ST/1004/2020', '2020-04-24', 'Senin - Jum\'at', '2020-04-28', '2020-05-01', 'Membuat Aplikasi WasLinSek', NULL, NULL, NULL, NULL, 12, 22, '2020-04-23 19:40:44', '2020-04-27 00:08:37'),
(5, 'ST/1005/2020', '2020-04-24', 'Senin - Jum\'at', '2020-04-28', '2020-05-01', 'Membuat Aplikasi WasLinSek', NULL, NULL, NULL, NULL, 13, 23, '2020-04-23 19:40:44', '2020-04-27 00:08:37'),
(6, 'ST/1006/2020', '2020-04-24', 'Senin - Jum\'at', '2020-04-28', '2020-05-01', 'Membuat Aplikasi WasLinSek', NULL, NULL, NULL, NULL, 13, 21, '2020-04-23 19:40:44', '2020-04-27 00:08:37'),
(7, 'ST/1007/2020', '2020-04-24', 'Senin - Jum\'at', '2020-04-28', '2020-05-01', 'Membuat Aplikasi WasLinSek', NULL, NULL, NULL, NULL, 13, 22, '2020-04-23 19:40:44', '2020-04-27 00:08:37'),
(8, 'ST/1010/2020', '2020-04-27', 'Senin - Sabtu', '2020-04-27', '2020-05-01', 'Membuat Aplikasi Pengawasan', NULL, NULL, NULL, NULL, 12, 23, '2020-04-27 07:50:14', '2020-04-27 16:21:42'),
(15, 'ST/1010/2020', '2020-06-01', 'Senin - Jum\'at', '2020-06-01', '2020-06-05', 'Membuat Video', NULL, NULL, 'ST-131 Rancangan SI.PDF', NULL, 11, 22, '2020-06-08 02:33:09', '2020-06-08 13:22:41'),
(18, 'ST/1009/2020', '2020-06-01', 'Senin - Jumat', '2020-06-01', '2020-06-05', 'Membuat Aplikasi Waslinsek', 'BPKP Aceh', 'Faris Nur Rahman', 'ST-136 Analisis & Desain SI.PDF', NULL, 11, 22, '2020-06-08 05:19:29', '2020-06-11 17:49:29'),
(19, 'ST/1002/2020', '2020-06-01', 'Senin - Jumat', '2020-06-01', '2020-06-05', 'Membuat Aplikasi Logbook', 'BPKP Aceh', 'Faris Nur Rahman', '', NULL, 11, 23, '2020-06-09 00:35:04', '2020-06-11 18:06:37'),
(20, 'ST/1003/2020', '08-06-2020', 'Senin - Jumat', '08-06-2020', '12-06-2020', 'Membuat Aplikasi Waslinsek', 'BPKP Aceh', 'Faris Nur Rahman', NULL, NULL, 11, 21, '2020-06-09 18:20:40', '2020-06-11 18:06:20'),
(21, 'ST/1004/2020', '15-06-2020', 'Senin - Jumat', '15-06-2020', '19-06-2020', 'Melakukan Pengawasan Di Bidang Kesehatan', 'BPKP Aceh', 'Faris Nur Rahman', NULL, NULL, 11, 23, '2020-06-11 11:07:50', '2020-06-11 18:07:50');

-- --------------------------------------------------------

--
-- Table structure for table `perenc_tim`
--

CREATE TABLE `perenc_tim` (
  `id` bigint(20) UNSIGNED NOT NULL,
  ...
  `kode_tim` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bpkp_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `perenc_tim`
--

INSERT INTO `perenc_tim` (`id`, `nip`, `nama_pegawai`, `jabatan`, `kedudukan`, `kode_tim`, `bpkp_id`, `created_at`, `updated_at`) VALUES
(1, '199806982019121002', 'Faris Nur Rahman', 'Auditor Pelaksana', 'Anggota Tim', 'Tim 1', 11, '2020-04-27 04:13:58', '2020-04-21 02:04:53'),
(3, '199004252012101001', 'Heru Arif Wijaya', 'Auditor Pertama', 'Anggota Tim', 'Tim 1', 11, '2020-04-27 04:14:02', '2020-04-21 02:05:14'),
(4, '199804122019121002', 'Isna Habib', 'Auditor Pelaksana', 'Anggota Tim', 'Tim 1', 12, '2020-04-27 04:14:04', '2020-04-21 02:05:27'),
(5, '199704122019122001', 'Dita Ardia', 'Auditor Pelaksana', 'Anggota Tim', 'Tim 2', 11, '2020-04-27 04:14:07', '2020-04-21 02:05:32'),
(6, '200004122019122001', 'Audrey Marcella', 'Auditor Pelaksana', 'Anggota Tim', 'Tim 2', 11, '2020-04-27 13:54:13', '2020-04-21 02:05:36'),
(14, '199704122019122001', 'Wiwik Prihartono', 'Auditor Muda', 'Ketua Tim', 'Tim 1', 12, '2020-04-27 04:14:14', '2020-04-21 02:06:07'),
(15, '199604122019122001', 'Edi Mulya', 'Auditor Pertama', 'Ketua Tim', 'Tim 1', 13, '2020-04-27 13:52:58', '2020-04-21 02:06:07'),
(16, '200004122019122001', 'Andi M. Fauzan', 'Auditor Pelaksana', 'Anggota', 'Tim 1', 13, '2020-04-27 13:52:53', '2020-04-21 02:06:07'),
(17, '199604122019122001', 'Venni Habsari', 'Auditor Pelaksana', 'Anggota', 'Tim 1', 13, '2020-04-27 13:52:50', '2020-04-21 02:06:07'),
(18, '199604122019122001', 'Agus Wibowo', 'Auditor Muda', 'Ketua Tim', 'Tim 1', 11, '2020-04-27 13:55:40', '2020-04-21 02:06:07'),
(19, '198304122019122001', 'Adi Gemawan', 'Auditor Muda', 'Anggota Tim', 'Tim 1', 11, '2020-04-27 16:14:50', '2020-04-27 09:14:50'),
(22, '200004112019121001', 'hoam', 'Auditor Pelaksana', 'Anggota Tim', 'Tim 1', 14, '2020-04-28 23:27:45', '2020-04-28 23:27:45');
...
INSERT INTO `post` (`id`, `user_id`) VALUES
(1, 1),
(2, 4),
(3, 11),
(4, 23);
...
--
-- Table structure for table `prinas`
--

CREATE TABLE `prinas` (
  `id` int(2) NOT NULL,
  `kd_prinas` int(2) NOT NULL,
  `nama_pn` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `prinas`
--

INSERT INTO `prinas` (`id`, `kd_prinas`, `nama_pn`) VALUES
(1, 1, 'Pembangunan Manusia dan Pengentasan Kemiskinan'),
(2, 2, 'Infrastruktur dan Pemerataan Wilayah'),
(3, 3, 'Nilai Tambah Sektor Riil, Industrialisasi, dan Kesempatan Kerja'),
(4, 4, 'Ketahanan Pangan, Air, Energi, dan Lingkungan Hidup'),
(5, 5, 'Stabilitas Pertahanan dan Keamanan');

-- --------------------------------------------------------

--
-- Table structure for table `progpri`
--

CREATE TABLE `progpri` (
  `id` int(2) NOT NULL,
  `kd_progpri` int(2) DEFAULT NULL,
  `nama_pp` varchar(255) DEFAULT NULL,
  `prinas_id` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `progpri`
--

INSERT INTO `progpri` (`id`, `kd_progpri`, `nama_pp`, `prinas_id`) VALUES
(1, 1, 'Perlindungan Sosial dan Tata Kelola Kependudukan', 1),
(2, 2, 'Peningkatan Akses dan Mutu Pelayanan Kesehatan', 1),
(3, 3, 'Pemerataan Layanan Pendidikan Berkualitas dan Pengembangan Iptek-Inovasi', 1),
(4, 4, 'Pengentasan Kemiskinan', 1),
(5, 5, 'Pengembangan Budaya, Karakter, dan Prestasi Bangsa', 1),
(6, 1, 'Perluasan Infrastruktur Dasar', 2),
(7, 2, 'Penguatan Infrastruktur Kawasan Tertinggal dan Ketahanan Bencana', 2),
(8, 3, 'Peningkatan Konektivitas Multimedia dan Antarmuka Mendukung Pertumbuhan Ekonomi', 2),
(9, 4, 'Peningkatan Infrastruktur Perkotaan', 2),
(10, 5, 'Transformasi Digital', 2),
(11, 1, 'Penguatan Kewirausahaan dan UMKM', 3),
(12, 2, 'Peningkatan Nilai Tambah dan Investasi di Sektor Riil dan Industrialisasi', 3),
(13, 3, 'Peningkatan Produktivitas Tenaga Kerja dan Penciptaan Lapangan Kerja', 3),
(14, 4, 'Peningkatan Ekspor Bernilai Tambah Tinggi dan Penguatan Tingkat Komponen Dalam Negeri (TKDM)', 3),
(15, 5, 'Penguatan Pilar Pertumbuhan dan Daya Saing Ekonomi', 3),
(16, 1, 'Peningkatan Ketersediaan, Akses dan Kualitas Konsumsi Pangan', 4),
(17, 2, 'Peningkatan Kuantitas, Kualitas, dan Aksesibilitas Air', 4),
(18, 3, 'Pemenuhan Kebutuhan Energi melalui Peningkatan Energi Baru dan Terbarukan (EBT)', 4),
(19, 4, 'Peningkatan Kualitas Lingkungan ', 4),
(20, 5, 'Penguatan Ketahanan Bencana', 4),
(21, 1, 'Penguatan Kemampuan Pertahanan', 5),
(22, 2, 'Peningkatan Diplomasi Politik ', 5),
(23, 3, 'Penguatan Sistem Peradilan dan Upaya Anti Korupsi', 5),
(24, 4, 'Penanggulangan Terorisme, Peningkatan Siber dan Penguatan Keamanan Laut', 5),
(25, 5, 'Penanggulangan Narkotika dan Penguatan Kamtibnas', 5);
...
--
-- Table structure for table `sasaran_kp`
--

CREATE TABLE `sasaran_kp` (
  `id` int(11) NOT NULL,
  `nama_sasaran_kp` varchar(255) DEFAULT NULL,
  `objek_pengawasan_id` int(11) DEFAULT NULL,
  `kegpri_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sasaran_kp`
--

INSERT INTO `sasaran_kp` (`id`, `nama_sasaran_kp`, `objek_pengawasan_id`, `kegpri_id`, `created_at`, `updated_at`) VALUES
(1, 'Anak - anak yang putus sekolah bisa kembali bersekolah', NULL, 15, '2020-05-18 15:45:36', '2020-05-18 15:45:36'),
(2, 'Banyak keluarga yang tidak mampu medapatkan bantuan kesehatan', NULL, 8, '2020-05-18 15:59:03', '2020-05-18 15:59:03'),
(5, 'Percepatan Perbaikan gizi masyarakat', NULL, 8, '2020-06-01 19:15:02', '2020-06-01 19:15:02'),
(6, 'Semua masyarakat mendapatkan pengobatan yang layak', NULL, 8, '2020-06-07 19:19:09', '2020-06-07 19:19:09'),
(7, 'Masyarakat mendapatkan pendidikan yang layak', NULL, 15, '2020-06-09 12:45:38', '2020-06-09 12:45:38');

-- --------------------------------------------------------

--
-- Table structure for table `sasaran_pp`
--

CREATE TABLE `sasaran_pp` (
  `id` int(11) NOT NULL,
  `nama_sasaran_pp` varchar(255) DEFAULT NULL,
  `kegpri_id` int(11) DEFAULT NULL,
  `objek_pengawasan_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp()
...
--
-- Dumping data for table `sasaran_pp`
--

INSERT INTO `sasaran_pp` (`id`, `nama_sasaran_pp`, `kegpri_id`, `objek_pengawasan_id`, `created_at`, `updated_at`) VALUES
(1, 'Seluruh masyarakat mendapatkan Pendidikan yang Mencukupi', 15, NULL, '2020-05-18 15:44:56', '2020-05-18 15:44:56'),
(3, 'Seluruh masyarakat mendapatkan pelayanan kesehatan yang bermutu dan adil', 8, NULL, '2020-05-18 15:59:03', '2020-05-18 15:59:03'),
(4, 'Angka Partisipasi kasar Pendidikan SMP', 15, NULL, '2020-05-19 18:45:49', '2020-05-19 18:45:49'),
(5, 'Meningkatkan status keseluruhan ibu dan anak. KB, kesehatan reproduksi, serta gizi masyarakat', 7, 23, '2020-06-01 19:08:53', '2020-06-11 12:19:10'),
(6, 'Meningkatnya para lulusan SMA', 15, NULL, '2020-06-07 19:11:19', '2020-06-07 19:11:19'),
(7, 'Banyak lulusan sarjana yang mendapatkan pekerjaan', 15, NULL, '2020-06-07 19:24:16', '2020-06-07 19:24:16'),
(8, 'Banyak masyarakat mendapatkan pengobatan yang layak', 8, NULL, '2020-06-09 12:40:38', '2020-06-09 12:40:38'),
(9, 'Meningkatnya Partisipasi Pendidikan', 17, 22, '2020-06-11 11:42:31', '2020-06-11 11:42:31'),
(10, 'Meningkatnya Kualitas Pendidikan', 17, 22, '2020-06-11 11:42:56', '2020-06-11 11:42:56');
...
CREATE TABLE `subunit` (
  `id` int(11) NOT NULL,
  `nama_subunit` varchar(255) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `subunit` (`id`, `nama_subunit`, `unit_id`) VALUES
(1, 'Dinas Pendidikan dan Kebudayaan', 11),
(2, 'DInas SPIP', 12),
(3, 'Dinas Kesehatan', 21),
(4, 'RSUD Mantri Raga', 22),
(5, 'Dinas Pekerjaan Umum dan Tata Ruang', 31),
(6, 'Dinas Perumahan, Kawasan Permukiman dan Pertanahan', 41),
(7, 'Badan Kesatuan Bangsa dan Politik', 51),
(8, 'Satuan Polisi Pamong Praja dan Pemadam Kebakaran', 52),
(9, 'Dinas Sosial dan Pemberdayaan Masyarakat', 61),
(10, 'Badan Penanggulangan Bencana Daerah', 62);
...
INSERT INTO `unit` (`id`, `nama_unit`, `bidang_id`) VALUES
(11, 'Dinas Pendidikan dan Kebudayaan', 101),
(12, 'Dinas SPIP', 101),
(21, 'Dinas Kesehatan', 102),
(22, 'RSUD Mantri Raga', 102),
(31, 'Dinas Pekerjaan Umum dan Tata Ruang', 103),
(41, 'Dinas Pekerjaan Umum dan Tata Ruang', 104),
(51, 'Badan Kesatuan Bangsa dan Politik', 105),
(52, 'Satuan Polisi Pamong Praja dan Pemadam Kebakaran', 105),
(61, 'Dinas Sosial dan Pemberdayaan Masyarakat', 106),
(62, 'Badan Penanggulangan Bencana Daerah', 106);
...
INSERT INTO `urusan` (`id`, `nama_urusan`) VALUES
...
CREATE TABLE `users` (
  ...
  `npm` varchar(18) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`, `nama`, `npm`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `role`, `bpkp_id`, `created_at`, `updated_at`) VALUES
(2, 'Faris Nur Rahman', '199806982019121002', 'faris', 'faris@bpkp.go.id', NULL, '$2y$10$MNve5FHSitJjgOfT4Vv7fuV0fy/GNoMu5ohFanfZApcpo1n0x7EQy', 'xPnn4pVW5daA1dPxZrulgoPXXobmRbI0FpbEiKbiSJZUliPauGktieUy0r6p', 'admin', 11, '2020-04-16 01:43:07', '2020-04-21 19:40:28'),
(4, 'Adi Gemawan', '198304122019122001', 'adi', 'arraqiib.bpkp@gmail.com', NULL, '$2y$10$e.hsPpMvD2xT4Gom2yv2mOL2KDNpz9Hn95xNxCMDE9AemGRhiLWd2', 'Z88aiqhWvqVMZV68KJ86NF7yR6zNh3HsqaDoPpMhAJ9pBaDePRnFHkFTT5Ki', 'admin', 11, '2020-04-16 21:32:44', '2020-06-09 06:42:19'),
(11, NULL, NULL, 'rizal', 'rizal.bpkp@gmail.com', NULL, '$2y$10$2A5DlYKgBKy5QBVCmaPQKOGLHEQuccLbvWPrRjrIeEhHC/XJokPb.', '1F3JgI8m7fZUnADP5dRF3U2yOpN3c5XRG4751BmRO90aBdhZ2tYpLXIk6uFL', 'pengawas', 13, '2020-04-17 00:46:33', '2020-04-27 07:10:54'),
(23, NULL, NULL, 'venni', 'venny@gmail.com', NULL, '$2y$10$2E4nlbNpgVfBdPv4C6pGyOedYPUrkCPcxK4uTSWvLYlaTB5gNmsb2', 'm2nmWjd7ZmGi7fLosXgu5m5CJX7uT4riHQNueqTxaFdCXOkO1h7CAqEU7KO1', 'pelaksana', 13, '2020-04-23 23:34:46', '2020-04-27 07:10:45'),
(25, NULL, NULL, 'fauzan', 'fauzan@gmail.com', NULL, '$2y$10$qBCw2FVrCARt6ucPzxoHUuw/rLCn9/POgypci21HiDe.DIZHeshlW', 'm2nmWjd7ZmGi7fLosXgu5m5CJX7uT4riHQNueqTxaFdCXOkO1h7CAqEU7KO1', 'pengawas', 11, '2020-04-23 23:34:46', '2020-04-27 07:11:03'),
(26, NULL, NULL, 'dita', 'dita@gmail.com', NULL, '$2y$10$KQVv/CkiGhbIEV9imn3FgO9CjRVj6KonZV8zMhBnRxp08r5s7.Tzm', 'pJ8pKjR5CmmChti0WJOeKOHjPZcmsQIc2w4yU8dnLRbT7E7UQxSj96CPqNt3', 'pelaksana', 14, '2020-04-23 23:34:46', '2020-04-27 07:11:11'),
(27, NULL, NULL, 'lastri', 'lastri@gmali.com', NULL, '$2y$10$k5f4iQv.RUshuZ/feGIrw.ndat1g7OCFfrHYpvISDgI5A/nwHQzZi', 'zpUbkJdDoTmG7wS2hPiWENHhH0YN1orjf3HLNe4E1qpQ98dV5VqHrFOllNAA', 'member', 11, '2020-06-08 19:38:21', '2020-06-08 19:38:21');
...
--
-- Indexes for table `check_pemda`
--
ALTER TABLE `check_pemda`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `idk_sasaran_kp`
--
ALTER TABLE `idk_sasaran_kp`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `idk_sasaran_pp`
--
ALTER TABLE `idk_sasaran_pp`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `perenc_objek`
--
ALTER TABLE `perenc_objek`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `perenc_pelaksanaan`
--
ALTER TABLE `perenc_pelaksanaan`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `perenc_st`
--
ALTER TABLE `perenc_st`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `perenc_tim`
--
ALTER TABLE `perenc_tim`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `prinas`
--
ALTER TABLE `prinas`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `progpri`
--
ALTER TABLE `progpri`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `sasaran_kp`
--
ALTER TABLE `sasaran_kp`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sasaran_pp`
--
ALTER TABLE `sasaran_pp`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `check_pemda`
--
ALTER TABLE `check_pemda`
...
--
-- AUTO_INCREMENT for table `idk_sasaran_kp`
--
ALTER TABLE `idk_sasaran_kp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `idk_sasaran_pp`
--
ALTER TABLE `idk_sasaran_pp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `kegpri`
--
ALTER TABLE `kegpri`
...
--
-- AUTO_INCREMENT for table `perenc_objek`
--
ALTER TABLE `perenc_objek`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `perenc_pelaksanaan`
--
ALTER TABLE `perenc_pelaksanaan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `perenc_st`
--
ALTER TABLE `perenc_st`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `perenc_tim`
--
ALTER TABLE `perenc_tim`
...
--
-- AUTO_INCREMENT for table `prinas`
--
ALTER TABLE `prinas`
  MODIFY `id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `progpri`
--
ALTER TABLE `progpri`
  MODIFY `id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `sasaran_kp`
--
ALTER TABLE `sasaran_kp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `sasaran_pp`
--
ALTER TABLE `sasaran_pp`
...
--
-- Constraints for table `bpkp`
--
ALTER TABLE `bpkp`
  ADD CONSTRAINT `bpkp_ibfk_1` FOREIGN KEY (`kd_kl`) REFERENCES `kementerianlembaga` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`bpkp_id`) REFERENCES `bpkp` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
