...
<head>
  ...
  <title>{{config('waslinsek.title')}}</title>
  <meta content="" name="descriptison">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{config('waslinsek.logo_url')}}" rel="icon">
  ...
  <link href="{{asset('lumia/assets/vendor/icofont/icofont.min.css')}}" rel="stylesheet">
  <link href="{{asset('lumia/assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
  <link href="{{asset('lumia/assets/vendor/animate.css/animate.min.css')}}" rel="stylesheet">
  <link href="{{asset('lumia/assets/vendor/venobox/venobox.css')}}" rel="stylesheet">
  <link href="{{asset('lumia/assets/vendor/owl.carousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <h1><a href="http://www.bpkp.go.id"><img src="{{config('waslinsek.logo_url')}}" alt="" class="img-fluid"></a></h1>
  ...
  <!-- ======= Hero Section ======= -->
<section id="hero" style="background: url('{{config('waslinsek.banner_url')}}');" class="d-flex flex-column justify-content-center align-items-center" >
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>{{config('waslinsek.welcome_message')}}<span>@WasLinSek</span></h1>
      <h2>{{config('waslinsek.sub_welcome_message')}}</h2>
      <a href="{{config('waslinsek.welcome_message_button_url')}}"" class="btn-get-started scrollto">{{config('waslinsek.welcome_message_button_text')}}</a>
    </div>
  </section><!-- End Hero -->
  ...
  <!-- Vendor JS Files -->
  <script src="{{asset('lumia/assets/vendor/jquery/jquery.min.js')}}"></script>
  <script src="{{asset('lumia/assets/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
  <script src="{{asset('lumia/assets/vendor/jquery.easing/jquery.easing.min.js')}}"></script>
  <script src="{{asset('lumia/assets/vendor/php-email-form/validate.js')}}"></script>
  <script src="{{asset('lumia/assets/vendor/waypoints/jquery.waypoints.min.js')}}"></script>
  <script src="{{asset('lumia/assets/vendor/counterup/counterup.min.js')}}"></script>
  <script src="{{asset('lumia/assets/vendor/isotope-layout/isotope.pkgd.min.js')}}"></script>
  <script src="{{asset('lumia/assets/vendor/venobox/venobox.min.js')}}"></script>
  <script src="{{asset('lumia/assets/vendor/owl.carousel/owl.carousel.min.js')}}"></script>
